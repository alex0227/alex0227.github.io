---
layout: post
title: Linux下查看服务器配置的命令
categories: 命令
description: Linux下查看服务器配置的命令
keywords:  命令
---
...
NUMA node1 CPU(s):     6-11123456789101112131415161718192021222324
```
查看CPU型号
...
[root@k80 ~]# cat /proc/cpuinfo | grep name | cut -f2 -d: | uniq -c
     12  Intel(R) Xeon(R) CPU E5-2609 v3 @ 1.90GHz12
```
查看物理CPU个数
```
...
本文来自 wuya0323 的CSDN 博客 ，全文地址请点击：https://blog.csdn.net/u011636440/article/details/78611838?utm_source=copy
